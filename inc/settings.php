        ...
        public function build_settings()
        {
            if (!SCC()->permission_manager('admin')) {
                ...
                <div class="settings-area">
                    <div id="settings-calendar" class="settings-group calendar current" data-id="calendar"><?php
                        echo SCC()->cal_settings->output_settings_fields(); ?>
                    </div>
                    <div id="settings-checklists" class="settings-group checklists" data-id="checklists"><?php
                        echo SCC()->check_settings->output_checklist_settings(); ?>
                    </div>
                    <div id="settings-pipeline" class="settings-group pipeline" data-id="pipeline"><?php
                        echo SCC()->pipe_settings->output_settings_fields(); ?>
                    </div>
                </div>
            <?php
        }
